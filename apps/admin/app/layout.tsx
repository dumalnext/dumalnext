...
export const metadata: Metadata = {
  title: "Administrator Portal | Dumalneg National High School",
  description: "Official School Administrator Portal for Dumalneg National High School",
};
  ...
  return (
    <html lang="en" className="h-full">
      <body className="min-h-full flex flex-col bg-slate-50 text-slate-900">
        {/* DepEd & DNHS School Administrator Header */}
          ...
          <div className="max-w-7xl mx-auto flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-xs text-slate-300 font-medium">
                School Administrator Portal: Admissions, Sectioning, &amp; Scheduling
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-4">
            <div>
              <p className="font-semibold text-slate-200">
                Dumalneg National High School - Office of the Principal &amp; Administration
              </p>
              <p className="mt-1">
